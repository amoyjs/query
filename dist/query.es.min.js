function show(){for(var a=0;a<this.length;a++)this[a].visible=!0;return this}function hide(){for(var a=0;a<this.length;a++)this[a].visible=!1;return this}function get(a){if(a)return this[a];for(var b=[],c=0;c<this.length;c++)b.push(this[c]);return b}function width(a){if("number"==typeof a)for(var b=0;b<this.length;b++)this[b].width=a;else return this[0].width}function height(a){if("number"==typeof a)for(var b=0;b<this.length;b++)this[b].height=a;else return this[0].height}function position(){return{x:this[0]?this[0].x:0,y:this[0]?this[0].y:0}}function children(){return this[0]?this[0].children:[]}function count(){return this.length}function first(){return this[0]}function last(){return this[this.length-1]}function each(a){for(var b=0;b<this.length;b++)a(this[b],b)}function empty(){for(var a=0;a<this.length;a++)this[a].removeChildren()}function parent(){return this[0]?this[0].parent:null}function text(){console.log("text() not support yet")}function css(){console.log("css() not support yet")}function find(){console.log("find() not support yet")}function offset(){console.log("offset() not support yet")}function prev(){console.log("prev() not support yet")}function next(){console.log("next() not support yet")}var instance=/*#__PURE__*/Object.freeze({show:show,hide:hide,get:get,width:width,height:height,position:position,children:children,count:count,first:first,last:last,each:each,empty:empty,parent:parent,text:text,css:css,find:find,offset:offset,prev:prev,next:next}),fns=[];function use(a){fns.push(a)}function extend(a){var b=this;void 0===a&&(a=[]),Array.isArray(a)?a.map(function(a){return extend.bind(b)(a)}):"object"==typeof a?Object.assign(this.prototype,a):console.error("query extension's type must be \"object\" or \"object[]\"")}function sprite(a){return"undefined"!=typeof a._anchor&&"undefined"==typeof a._font}function text$1(a){return"string"==typeof a._font}function container(a){return"undefined"==typeof a.anchor}var is=/*#__PURE__*/Object.freeze({sprite:sprite,text:text$1,container:container});function createQuery(a,b){return function(c){var d=[],e=fns.reduce(function(a,c){return c(a,b)},c);// @ts-ignore

function show(){for(var a=0;a<this.length;a++)this[a].visible=!0}function hide(){for(var a=0;a<this.length;a++)this[a].visible=!1}function get(){return this[0]}function width(a){for(var b=0;b<this.length;b++)this[b].width=a;return this[0].width}function height(a){for(var b=0;b<this.length;b++)this[b].height=a;return this[0].height}function position(){return{x:this[0]?this[0].x:0,y:this[0]?this[0].y:0}}var instance=/*#__PURE__*/Object.freeze({show:show,hide:hide,get:get,width:width,height:height,position:position}),fns=[];function use(a){fns.push(a)}function extend(a){var b=this;void 0===a&&(a=[]),Array.isArray(a)?a.map(function(a){return extend.bind(b)(a)}):"object"==typeof a?Object.assign(this.prototype,a):console.error("query extension's type must be \"object\" or \"object[]\"")}function sprite(a){return"undefined"!=typeof a._anchor&&"undefined"==typeof a._font}function text(a){return"string"==typeof a._font}function container(a){return"undefined"==typeof a.anchor}var is=/*#__PURE__*/Object.freeze({sprite:sprite,text:text,container:container});function createQuery(a,b){return function(c){var d=[],e=fns.reduce(function(a,c){return c(a,b)},c);// @ts-ignore

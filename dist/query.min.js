...
switch(typeof k){case"string":if(e=k.trim(),["container","sprite","text"].includes(e))j.push.apply(j,d(e,f(a)));else{var l=c(e);l.map(function(b){return j.push.apply(j,h(b.key,b.value,f(a)))})}break;case"object":j.push.apply(j,g(e,f(a)));break;default:}return Object.assign(j,b.prototype)}}// 匹配 `[${key}=${value}]` 形式字符串

...
function b(a){void 0===a&&(a="");var b=[];return a.split(",").map(function(a){if(a=a.trim(),a.startsWith(".")&&b.push({key:"name",value:a.slice(1)}),i.test(a)){var c=d(a),e=c[0],f=c[1];b.push({key:e,value:f})}}),b}function c(a,b){return b.filter(function(b){return h[a](b)})}function d(a){var b=a.match(i),c=b[0],d=b[1],e=b[2];return[d,e]}function e(a){var b=[],c=function(a){0<a.children.length&&(b.push.apply(b,a.children),a.children.map(function(a){return c(a)}))};return c(a),b}function f(a,b){return b.filter(function(b){return b===a})}function g(a,b,c){return c.filter(function(c){return c[a]===b})}var h=/*#__PURE__*/Object.freeze({sprite:function(a){return"undefined"!=typeof a._anchor&&"undefined"==typeof a._font},text:function(a){return"string"==typeof a._font},container:function(a){return"undefined"==typeof a.anchor}}),i=/\[(.*)\=(.*)\]/,j=/*#__PURE__*/Object.freeze({on:function(a,b){void 0===a&&(a=""),void 0===b&&(b=function(){});for(var c=a.split(" "),d=0;d<this.length;d++)for(var e=0;e<c.length;e++)this[d].interactive=!0,this[d].on(c[e],b);return this},off:function(a){void 0===a&&(a="");for(var b=a.split(" "),c=0;c<this.length;c++)for(var d=0;d<b.length;d++)this[c].off(b[d]);return this}}),k=function(b){return window.$=a(b,k)};return k.extend=function(a){void 0===a&&(a={}),Object.assign(this.prototype,a)},k.extend(j),k});

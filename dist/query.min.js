(function(a,b){"object"==typeof exports&&"undefined"!=typeof module?module.exports=b():"function"==typeof define&&define.amd?define(b):(a=a||self,a.query=b())})(this,function(){'use strict';function a(a){if("number"==typeof a)for(var b=0;b<this.length;b++)this[b].width=a;else return this[0].width}function b(a){if("number"==typeof a)for(var b=0;b<this.length;b++)this[b].height=a;else return this[0].height}function c(a){var b=this;void 0===a&&(a=[]),Array.isArray(a)?a.map(function(a){return c.bind(b)(a)}):"object"==typeof a?Object.assign(this.prototype,a):console.error("query extension's type must be \"object\" or \"object[]\"")}function d(a,b){return function(c){var d=[],g=k.reduce(function(a,c){return c(a,b)},c);// @ts-ignore
switch(typeof g){case"string":if(c=g.trim(),["container","sprite","text"].includes(c))d.push.apply(d,f(c,h(a)));else{var j=e(c);j.map(function(b){return d.push.apply(d,i(b.key,b.value,h(a)))})}break;case"object":d.push(g);break;default:}return Object.assign(d,b.prototype)}}// 匹配 `[${key}=${value}]` 形式字符串
function e(a){void 0===a&&(a="");var b=[];return a.split(",").map(function(a){if(a=a.trim(),a.startsWith(".")&&b.push({key:"name",value:a.slice(1)}),m.test(a)){var c=g(a),d=c[0],e=c[1];b.push({key:d,value:e})}}),b}function f(a,b){return b.filter(function(b){return l[a](b)})}function g(a){var b=a.match(m),c=b[0],d=b[1],e=b[2];return[d,e]}function h(a){var b=[],c=function(a){0<a.children.length&&(b.push.apply(b,a.children),a.children.map(function(a){return c(a)}))};return c(a),b}function i(a,b,c){return c.filter(function(c){return c[a]===b})}var j=/*#__PURE__*/Object.freeze({show:function(){for(var a=0;a<this.length;a++)this[a].visible=!0;return this},hide:function(){for(var a=0;a<this.length;a++)this[a].visible=!1;return this},get:function(a){if(a)return this[a];for(var b=[],c=0;c<this.length;c++)b.push(this[c]);return b},width:a,height:b,position:function(){return{x:this[0]?this[0].x:0,y:this[0]?this[0].y:0}},children:function(){return this[0]?this[0].children:[]},count:function(){return this.length},first:function(){return this[0]},last:function(){return this[this.length-1]},each:function(a){for(var b=0;b<this.length;b++)a(this[b],b)},empty:function(){for(var a=0;a<this.length;a++)this[a].removeChildren()},parent:function(){return this[0]?this[0].parent:null},text:function(){console.log("text() not support yet")},css:function(){console.log("css() not support yet")},find:function(){console.log("find() not support yet")},offset:function(){console.log("offset() not support yet")},prev:function(){console.log("prev() not support yet")},next:function(){console.log("next() not support yet")}}),k=[],l=/*#__PURE__*/Object.freeze({sprite:function(a){return"undefined"!=typeof a._anchor&&"undefined"==typeof a._font},text:function(a){return"string"==typeof a._font},container:function(a){return"undefined"==typeof a.anchor}}),m=/\[(.*)\=(.*)\]/,n="undefined"==typeof globalThis?"undefined"==typeof window?"undefined"==typeof global?"undefined"==typeof self?{}:self:global:window:globalThis,o=function(a,b){return b={exports:{}},a(b,b.exports),b.exports}(function(a,b){(function(a,c){c(b)})(n,function(a){var e=Math.round;function b(a){var b={},c=b.toString.call(a);if(null==a)return a+"";"Boolean Number String Function Array Date RegExp Object Error Symbol".split(" ").forEach(function(a){b["[object "+a+"]"]=a.toLowerCase()});return"object"==typeof a||"function"==typeof a?b[c]||"object":typeof a}function c(a,b,c){i.includes(b)?(!a.RTouch&&(a.RTouch=new k(a)),a.RTouch.on(b,c)):(a.interactive=!0,a.on(b,c))}function d(a,b,c){i.includes(b)&&a.RTouch?a.RTouch.off(b,c):(a.interactive=!0,a.off(b,c))}var f=/** @class */function(){function a(){this.handlers=[]}return a.prototype.add=function(a){return this.handlers.push(a),this},a.prototype.del=function(a){var b=this;return a?this.handlers.map(function(c,d){c===a&&b.handlers.splice(d,1)}):this.handlers=[],this},a.prototype.fire=function(a){if(this.handlers&&this.handlers.length)return this.handlers.map(function(b){"function"==typeof b&&b(a)}),this},a.prototype.clear=function(){this.handlers=[]},a}(),g=function(a,c){if("object"!==b(a))return a;for(var d,e=a,f=c.split("."),g=0,h=f.length;g<h;g++)if(d=f[g],d)if(e[d])e=e[d];else{e=void 0;break}return e},h={getFingers:function(a){return g(a,"data.originalEvent.touches.length")||1},getPoint:function(a,b){if("touch"===a.data.pointerType){var c=a.data.originalEvent.touches;return{x:e(c[b].pageX),y:e(c[b].pageY)}}return{x:e(a.data.global.x),y:e(a.data.global.y)}},getVector:function(a,b){var c=e(a.x-b.x),d=e(a.y-b.y);return{x:c,y:d}},getLength:function(a){var b=Math.sqrt;return b(a.x*a.x+a.y*a.y)},getAngle:function(a,b){var c=Math.acos;if("object"!=typeof a||"object"!=typeof b)return void console.error("getAngle error!");// 判断方向，顺时针为 1 ,逆时针为 -1；
